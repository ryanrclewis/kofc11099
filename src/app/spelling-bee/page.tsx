...
export const metadata = {
  title: 'Spelling Bee &#8211; &#8211; Knights of Columbus &#8211; | Knights of Columbus Council #11099',
};
            ...
            <p className="text-sm sm:text-base leading-relaxed text-slate-600 mb-4 font-medium last:mb-0">
              Downloadable Files
                ...
                <p className="text-sm text-slate-500">
                  Join us for our annual Spelling Bee &#8211; &#8211; Knights of Columbus &#8211; event! Download the files on the right for registration and schedules.
                </p>
              )}
            </div>
