...
export const metadata = {
  title: '2018 Archangel Newsletters &#8211; &#8211; Knights of Columbus &#8211; | Knights of Columbus Council #11099',
};
...
export default function Page() {
  return (
    <div className="flex flex-col min-h-screen bg-light">
      <SectionHeader
        title="2018 Archangel Newsletters &#8211; &#8211; Knights of Columbus &#8211;"
        subtitle="Council fraternal activities, charity challenges, and parish events."
        breadcrumbs={[
          { name: 'Events', href: '/upcoming-events' },
          { name: '2018 Archangel Newsletters &#8211; &#8211; Knights of Columbus &#8211;', href: '/june-2018' }
        ]}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="card-premium p-8 rounded-2xl bg-white border border-slate-100">
              ...
              {false ? (
                ...
                <p className="text-sm text-slate-500">
                  Join us for our annual 2018 Archangel Newsletters &#8211; &#8211; Knights of Columbus &#8211; event! Download the files on the right for registration and schedules.
                </p>
              )}
            </div>
          ...
          <PdfDownloadCard
            key="/wp-content/uploads/2018/07/Archangel-Newsletter-May-2018.pdf"
            title="Archangel-Newsletter-May-2018"
            pdfUrl="/wp-content/uploads/2018/07/Archangel-Newsletter-May-2018.pdf"
          />
