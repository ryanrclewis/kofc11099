...
export const metadata = {
  title: '2019 Archangel Newsletters | Knights of Columbus Council #11099',
};
            ...
            <div className="card-premium p-8 rounded-2xl bg-white border border-slate-100">
              ...
              {false ? (
                ...
                <p className="text-sm text-slate-500">
                  Join us for our annual 2019 Archangel Newsletters event! Download the files on the right for registration and schedules.
                </p>
              )}
            </div>
