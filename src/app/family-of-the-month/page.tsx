      ...
      <div className="max-w-3xl mx-auto px-4 py-16 w-full">
        <div className="card-premium p-8 rounded-2xl bg-white border border-slate-100">
          ...
          <div className="relative pl-8 border-l border-slate-200 py-2">
            ...
            <p className="text-lg font-bold text-secondary font-serif mt-0.5">William and Joyce Richardson</p>
          </div>
          ...
          <div className="relative pl-8 border-l border-slate-200 py-2">
            ...
            <p className="text-lg font-bold text-secondary font-serif mt-0.5">Don and Gayle Gardner</p>
          </div>
          ...
          <div className="relative pl-8 border-l border-slate-200 py-2">
            ...
            <p className="text-lg font-bold text-secondary font-serif mt-0.5">Dick and Cathy Schaefer</p>
          </div>
          ...
          <div className="relative pl-8 border-l border-slate-200 py-2">
            ...
            <p className="text-lg font-bold text-secondary font-serif mt-0.5">John and Karen Crowley</p>
          </div>
          ...
          <div className="relative pl-8 border-l border-slate-200 py-2">
            ...
            <p className="text-lg font-bold text-secondary font-serif mt-0.5">Mike &amp; Marianne Vasievich</p>
          </div>
          ...
          <div className="relative pl-8 border-l border-slate-200 py-2">
            ...
            <p className="text-lg font-bold text-secondary font-serif mt-0.5">Thomas and Laura Demko</p>
          </div>
