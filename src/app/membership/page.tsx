...
export const metadata = {
  title: 'Membership &#8211; &#8211; Knights of Columbus &#8211; | Knights of Columbus Council #11099',
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <p className="text-sm sm:text-base leading-relaxed text-slate-600 mb-4 font-medium last:mb-0">
              in the meantime any member can email or call me for any information needed
            </p>
  

            <p className="text-sm sm:text-base leading-relaxed text-slate-600 mb-4 font-medium last:mb-0">
              Note: You will need sign-in credentials to view this page. 
Contact Eric Cullimore at ecullimorekofc11099@gmail.com for assistance..
            </p>
  
                </div>
              ) : (
                <p className="text-sm text-slate-500">
                  Join us for our annual Membership &#8211; &#8211; Knights of Columbus &#8211; event! Download the files on the right for registration and schedules.
                </p>
              )}
            </div>
