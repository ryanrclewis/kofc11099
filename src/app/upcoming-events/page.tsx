    ...
    <div className="flex flex-col min-h-screen bg-light">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <PdfDownloadCard
            key="/wp-content/uploads/2023/09/2023-2024-Schedule-of-events-as-of-2023-09-27-1.pdf"
            title="2023-2024-Schedule-of-events-as-of-2023-09-27-1"
            pdfUrl="/wp-content/uploads/2023/09/2023-2024-Schedule-of-events-as-of-2023-09-27-1.pdf"
          />
