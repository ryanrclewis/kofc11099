...
export const metadata = {
  title: 'Family of the Year &#8211; &#8211; Knights of Columbus &#8211; | Knights of Columbus Council #11099',
};
...
export default function Page() {
  return (
    <div className="flex flex-col min-h-screen bg-light">
      <SectionHeader
        title="Family of the Year &#8211; &#8211; Knights of Columbus &#8211;"
        subtitle="Our highest annual fraternal honor awarded for exceptional council leadership."
        breadcrumbs={[
          { name: 'Recognition', href: '/recognition' },
          { name: 'Family of the Year &#8211; &#8211; Knights of Columbus &#8211;', href: '/family-of-the-year' }
        ]}
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="card-premium p-8 rounded-2xl bg-white border border-slate-100 flex items-start gap-5">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-secondary font-serif mt-1">2019  John and Beth Gordon</h3>
            </div>
          </div>
