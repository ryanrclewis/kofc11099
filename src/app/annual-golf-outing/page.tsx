...
export const metadata = {
  title: 'Annual Golf Outing &#8211; &#8211; Knights of Columbus &#8211; | Knights of Columbus Council #11099',
};
...
export default function Page() {
  return (
    <div className="flex flex-col min-h-screen bg-light">
      <SectionHeader
        title="Annual Golf Outing &#8211; &#8211; Knights of Columbus &#8211;"
        subtitle="Council fraternal activities, charity challenges, and parish events."
        breadcrumbs={[
          { name: 'Events', href: '/upcoming-events' },
          { name: 'Annual Golf Outing &#8211; &#8211; Knights of Columbus &#8211;', href: '/annual-golf-outing' }
        ]}
      />
            ...
            <div className="card-premium p-8 rounded-2xl bg-white border border-slate-100">
              ...
              {false ? (
                ...
                <p className="text-sm text-slate-500">
                  Join us for our annual Annual Golf Outing &#8211; &#8211; Knights of Columbus &#8211; event! Download the files on the right for registration and schedules.
                </p>
              )}
            </div>
